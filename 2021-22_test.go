...
on x=10..10,y=10..10,z=10..10`
	...
	if count != 39 {
		t.Errorf("Bad count %v vs 39", count)
	}
}

func Test2021Day22Focus(t *testing.T) {
	data := `on x=-1..1,y=-1..1,z=-1..1
	off x=0..0,y=0..0,z=0..0`

	count := buildCubeAndCount(data)

	if count != 26 {
		t.Errorf("Bad count %v vs 26", count)
	}
}

func Test2021Day22Part1Harder(t *testing.T) {

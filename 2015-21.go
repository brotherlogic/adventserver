...
func runBackwardsFight(ehitp, edamage, earm int) int {
	weapons := []adjust{
		{8, 4, 0},
		{10, 5, 0},
		{25, 6, 0},
...
func (s *Server) Solve2015day21part2(ctx context.Context) (*pb.SolveResponse, error) {
	return &pb.SolveResponse{Answer: int32(runBackwardsFight(103, 9, 2))}, nil
}

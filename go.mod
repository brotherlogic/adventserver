module github.com/brotherlogic/adventserver

go 1.19

require (
	github.com/brotherlogic/filecopier v0.0.0-20221020033051-e91ae5447e8f
...
require (
	...
	github.com/brotherlogic/keystore v0.0.0-20221019091904-d39e625424df // indirect

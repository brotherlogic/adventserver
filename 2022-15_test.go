...
func Test2022_15_1_Main(t *testing.T) {
	...
	result := countKnown(data, 10)
	if result != 26 {
		t.Errorf("Bad count of known: %v (26)", result)
	}
}

func Test2022_15_2_Main(t *testing.T) {
	data := `Sensor at x=2, y=18: closest beacon is at x=-2, y=15
	Sensor at x=9, y=16: closest beacon is at x=10, y=16
	Sensor at x=13, y=2: closest beacon is at x=15, y=3
	Sensor at x=12, y=14: closest beacon is at x=10, y=16
	...
	result := findKnown(data, 20)
	if result != 56000011 {
		t.Errorf("Bad count of known: %v (26)", result)
	}
}

func Test2022_15_2_Full(t *testing.T) {
	data := `Sensor at x=3889276, y=3176133: closest beacon is at x=3738780, y=3090050
